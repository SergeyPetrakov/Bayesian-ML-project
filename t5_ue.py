...
rubq_entities = pd.read_json("data/RuBQ_2.0_test.json")["question_uris"].apply(
...
data = list(full_rubq_test_clear.question_eng)
...
main_data_uncertainty, result_table = total_experiment_uncertainty_mc_dropout(
    ...
    data = data,
    answers = answers,
    data_name = "RuBQ 2.0 full test",
    output_file_name = "RUBQ_2_0_FULL_TEST_DROPOUT_BS20",
    model = t5_qa_model,
    tokenizer = t5_tok,
    model_type = "T5_XL_SSM_NQ_model",
    num_quantiles = 20,
...
main_data_uncertainty, result_table = total_experiment_uncertainty_mc_dropout(
    ...
    answers = answers,
    data_name = "RuBQ 2.0 full test",
    output_file_name = "RUBQ_2_0_FULL_TEST_DROPOUT_BS10",
    model = t5_qa_model,
    tokenizer = t5_tok,
    model_type = "T5_XL_SSM_NQ_model",
    num_quantiles = 20,
